...
const tick = () => {
    ...
    cameraGroup.position.x += (parallaxX - cameraGroup.position.x) * parallaxStrength * deltaTime
    cameraGroup.position.y += (parallaxY - cameraGroup.position.y) * parallaxStrength * deltaTime
